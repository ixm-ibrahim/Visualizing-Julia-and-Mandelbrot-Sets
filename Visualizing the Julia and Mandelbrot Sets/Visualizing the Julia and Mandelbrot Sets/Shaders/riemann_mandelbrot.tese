...
void main()
{
    ...
    if (riemannSphere)
    {
        if (terrain != 0)
        {
            ...
            FragPosModel += Mandelbrot() * Normal * scale;
        }
    ...
    else
    {
        ...
        //FragPos = aPos.xy;
        FragPosModel = vec3(radius*FragPosModel.xy/zoom, 0);
...
float Mandelbrot()
{
    ...
    {
        height = 0;
        mandelbrotColor = vec3(1,0,0);
    }
    else
    {
        height = 1 - pow(dist,1);
        mandelbrotColor = 1 - vec3(height);
    }
